package com.mrsan.ads.sdkdemo.adapter;

import static com.mrsan.ads.sdk.util.Constant.ADMOB;
import static com.mrsan.ads.sdk.util.Constant.APPLOVIN;
...
import static com.mrsan.ads.sdk.util.Constant.FACEBOOK;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if (viewType == VIEW_ITEM) {
            ...
            switch (Constant.NATIVE_STYLE) {
                case "news":
                    v = LayoutInflater.from(parent.getContext()).inflate(com.mrsan.ads.sdk.R.layout.view_native_ad_news, parent, false);
                    break;
                case "radio":
                    v = LayoutInflater.from(parent.getContext()).inflate(com.mrsan.ads.sdk.R.layout.view_native_ad_radio, parent, false);
                    break;
                case "video_small":
                    v = LayoutInflater.from(parent.getContext()).inflate(com.mrsan.ads.sdk.R.layout.view_native_ad_video_small, parent, false);
                    break;
                case "video_large":
                    v = LayoutInflater.from(parent.getContext()).inflate(com.mrsan.ads.sdk.R.layout.view_native_ad_video_large, parent, false);
                    break;
                default:
                    v = LayoutInflater.from(parent.getContext()).inflate(com.mrsan.ads.sdk.R.layout.view_native_ad_medium, parent, false);
                    break;
            }
